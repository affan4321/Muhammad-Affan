      ...
      >
        ...
        >
          <label style={{ display: "grid", gap: 10 }}>
            <span style={{ fontSize: 13, letterSpacing: "0.08em", color: "#9dffb9" }}>Your Name</span>
            <input
              value={playerName}
          ...
          <div style={{ display: "grid", gap: 12 }}>
            <span style={{ fontSize: 13, letterSpacing: "0.08em", color: "#9dffb9" }}>Graphics Quality</span>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: 12 }}>
              {GRAPHICS_QUALITY_ORDER.map((quality) => {
                ...
                return (
                  ...
                  >
                    <div style={{ fontSize: 18, fontWeight: 700, marginBottom: 6 }}>{preset.label}</div>
                    <div style={{ fontSize: 12, color: "rgba(231, 255, 233, 0.7)", lineHeight: 1.5 }}>
                      {preset.description}
                    </div>
                  </button>
                );
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
            <div style={{ fontSize: 12, color: "rgba(231, 255, 233, 0.7)" }}>
